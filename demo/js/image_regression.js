...
// create neural net
var t = "layer_defs = [];\n\
layer_defs.push({type:'input', out_sx:6, out_sy:1, out_depth:2}); // 2 inputs: x, y \n\
...
function binary(number){
  var string = number.toString(3).padStart(6, "0");
  var bits = [];
  for(var i=0; i<string.length; i++){
    bits[i] = parseInt((string[i]-1)*0.7);
  }
  return bits;
}
function draw() {
